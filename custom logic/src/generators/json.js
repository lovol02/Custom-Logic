...
var code=block.getFieldValue('name1');
return code;};
jsonGenerator.forBlock['bound'] = function(block) {
var code=block.getFieldValue('name1').toString();
return code;};
...
var code='('+block.getFieldValue('name1')+" "+jsonGenerator.statementToCode(block, 'name2').slice(2)+" "+block.getFieldValue('name3')+" "+block.getFieldValue('name4')+" "+jsonGenerator.statementToCode(block, 'name5').slice(2)+" "+block.getFieldValue('name6')+" "+jsonGenerator.statementToCode(block, 'name7').slice(2)+')';
return code;};
